...
public class groceryApp {
    ...
    public static void sortByKey(HashMap<String, Integer> map) {
        ...
        public static void main(String[] args) {
            ...
            Scanner askss = new Scanner(System.in);
            String userConfirms = askss.next();
            confirm = userConfirms.equalsIgnoreCase("y");
            while (confirm) {
            ...
            confirm = userConfirm.equalsIgnoreCase("y");
                } while (confirm);    ////this pulls up scanner.nextLine(); if y or yes it returns true
